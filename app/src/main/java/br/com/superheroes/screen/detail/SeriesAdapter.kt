...
class SeriesAdapter(
    ...
    series: MutableList<Series> = mutableListOf()
) : SimpleAdapter<Series, SeriesAdapter.ViewHolder>(series) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int, item: Series) {
        with(holder) {
    ...
    override fun addItems(newItems: List<Series>) {
        ...
        if (oldItems.isEmpty()) {
            ...
            DiffUtil.calculateDiff(object : DiffUtil.Callback() {
                ...
                override fun areContentsTheSame(
                    ...
                    return oldItem is Series && oldItem.id == newItem.id
                }
